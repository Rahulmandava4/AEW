...
notebook_path = "output_notebook_coordinates_filtered_300_850.ipynb"
...
for pset in pressure_sets:
    ...
    output_path = f"output_notebook_coordinatesFiletered_{pset_str}2.ipynb"
    tuner_project_name = f"tuner_runmodel_{pset_str}2"
    model_save_name = f"best_modelcoordsfileteredx_{pset_str}2.keras"
