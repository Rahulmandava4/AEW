...
notebook_path = "output_notebookmodelnewmodel12_300.ipynb"
...
for pset in pressure_sets:
    ...
    output_path = f"output_notebook24_{pset_str}1.ipynb"
    tuner_project_name = f"tuner_run24_{pset_str}1"
    model_save_name = f"best_model24_{pset_str}1.keras"
